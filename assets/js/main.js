...
(function ($) {
    ...
    $('.header.main .main-menu > ul.nav > li').append('<img src="assets/img/icon/a-bg.svg" class="svg a-bg a-bg1" alt="">');
    $('.header.conference .main-menu > ul.nav > li').append('<img src="assets/img/icon/a-bg2.svg" class="svg a-bg a-bg2" alt="">');

    /*===================
    02: Off Canvas Menu
    =====================*/
    $('.panel .offcanvas-main-menu').find('ul li').parents('.offcanvas-main-menu ul li').addClass('has-sub-menu');
    $('.panel .offcanvas-main-menu').find(".has-sub-menu").prepend('<span class="submenu-button"></span>');


    $('.offcanvas-main-menu').find(".submenu-button").on("click", function(event){
    ...
    $(window).on("scroll", function () {
        ...
        if (scroll < 200) {
            $(".main-header.love-sticky").removeClass("sticky fixed-top fadeInDown animated");
        }
        else {
            $(".main-header.love-sticky").addClass("sticky fixed-top fadeInDown animated");
        }
    });
    ...
    $owlCarousel.each(function () {
        ...
        $t.owlCarousel({
            ...
            navText: ['<img src="assets/img/svg/angle-left.svg" alt="" class="svg"> ', '<img src="assets/img/svg/angle-right.svg" alt="" class="svg"> '],
    ...
    $(window).bind('scroll', function() {
        ...
        elems.each(function(index){
          ...
          if(currentTop >= elemTop && currentTop <= elemBottom){
            ...
            navElem.parent().addClass('current-menu-parent').siblings().removeClass( 'current-menu-parent' );
          }
        })
    });
